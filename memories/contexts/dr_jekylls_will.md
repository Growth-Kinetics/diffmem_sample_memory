# 📜 dr_jekylls_will Integration System [Strength: High]
This file serves as the central entity for Dr. Jekyll's holographic will, a document of significant legal and personal concern to Mr. Utterson.
...
*   **Utterson's Evolving Distress:** His initial assessment of the will was that it was "madness." After learning of Hyde's detestable character, he now fears it is a matter of "disgrace." The document is the primary catalyst for his investigation into the Jekyll-Hyde relationship.
*   **Perceived Danger:** Mr. Utterson is concerned that if Mr. Hyde becomes aware of the will's existence and terms, "he may grow impatient to inherit," posing a direct and mortal threat to Dr. Jekyll.
/END ⚡ **Context & Impact**
...
*   **Mr. Utterson:** [Role: Custodian & Objector] The keeper of the document, who is driven by its contents to protect his friend, Jekyll.
...
## SEMANTIC INDEX
{"name":"Dr. Jekyll's Will","aliases":["Jekyll's Will","The Holographic Will"],"type":"legal document","role":"Transfers Jekyll's estate to Hyde upon death or disappearance","strength":"High","hard_cues":["Holographic will","disappearance clause","three calendar months","Edward Hyde beneficiary","Utterson's safe"],"soft_cues":["Lawyer's eyesore","fanciful","immodest","friend and benefactor"],"emotional_cues":["Madness","disgrace","distress","danger","impatience to inherit"],"related_entities":["dr_henry_jekyll","mr_edward_hyde","mr_utterson"],"file":"dr_jekylls_will.md"}